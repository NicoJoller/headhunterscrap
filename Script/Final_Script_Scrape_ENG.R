...
# Function to recursively extract text and links from a URL
extract_text_recursively <- function(url, depth = 2, max_links = 10) {
  ...
  webpage <- tryCatch({
    ...
    message("Error opening the page ", url, ": ", conditionMessage(e))
    return(NULL)
  })
  ...
  # Find keywords in the text and extract the context
...
# Cluster configuration and execution of the parallel process
...
# Define URLs and perform processing
urls <- c(
  "https://www.abena.li/",
