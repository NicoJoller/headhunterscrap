...
author: "Nico Joller"
output: "Excel List and via Shiny Code a user friendly App Webpage"
...
My Goal is to provide an overview which services (keywords) are provided by which headhunter company. So that the HR Recruiting Division can look for a service and 

For the company I'm working for (a swiss accident insurance company) based on the predefined list of headhunter companies in Switzerland (which the company is currently working with) The list should contain the URL of the headhunter company and the keywords I defined. The keywords are: "Mandat", "Erfolgsbasis", "Festvermittlung", "Personalverleih", "Executive Search", "Headhunting", "Assessment", "Temporär".
